...
function DYNDECK.sc_lch_low(shipID, templateName)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "Deckeq Crane", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "Deckeq SH-3-1", -- unit name (Name this something identifiable if you wish to remove it later)
    
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "HS-12 Wyverns HiViz",
    ...
    local staticObj = {
        ["name"] = namePrefix .. "Deckeq SH-3-2", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14A 1", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14A 2", -- unit name (Name this something identifiable if you wish to remove it later)
    
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-51 Screaming Eagles 100",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 6.7391817566416,
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14A 3", -- unit name (Name this something identifiable if you wish to remove it later)
    
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-51 Screaming Eagles 102",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -5.0029690814996,
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14A 4", -- unit name (Name this something identifiable if you wish to remove it later)
    
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-51 Screaming Eagles 106",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -13.005046297121,
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14A 5", -- unit name (Name this something identifiable if you wish to remove it later)
    
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-51 Screaming Eagles 114",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -15.307549672268,
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14A 6", -- unit name (Name this something identifiable if you wish to remove it later)
    
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 216",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -21.875030227257,
...
function DYNDECK.sc_lch_med(shipID, templateName)
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VFA-196 Main Battery NA (1994-96)",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -3.3698449825059,
    ...
    local staticObj = {
        ["name"] = namePrefix .. "Deckeq SH-3 3", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "Deckeq SH-3 4", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 204",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 25.272174412871,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 203",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 25.90766034143,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 207",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 26.688365467764,
...
function DYNDECK.sc_lch_hvy(shipID, templateName)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "Deckeq SH-3 5", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "Deckeq SH-3H 6", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 201",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 18.179512487887,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 202",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 6.7391817566416,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 205",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -5.0029690814996,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 206",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -13.005046297121,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 210",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -15.307549672268,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 211",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -21.875030227257,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VS-35 Blue Wolves 704 (1994)",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 34.100242104084,
...
function DYNDECK.sc_rec_low(shipID, templateName)
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 212",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -35.445383461716,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 213",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -35.411844968488,
...
function DYNDECK.sc_rec_hvy(shipID, templateName)
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-51 Screaming Eagles",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = -35.411844968488,
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VS-35 Blue Wolves 700 CAG (1994)",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 34.100242104084,
...
function DYNDECK.sc_el2_f14(shipID, templateName)
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "VF-111 Sundowners 214",
                                            ["category"] = "Planes",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 35.445525464645,
...
function DYNDECK.sc_deckeq(shipID, templateName)
    ...
    -- Copy and paste over this with the units information
                                            ["livery_id"] = "sHS-12 Wyverns HiViz",
                                            ["category"] = "Helicopters",
                                            ["offsets"] = 
                                            {
                                                ["y"] = 19.992908088869,
...
function DYNDECK.sc_fantail_f14(shipID, templateName)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14 4", -- unit name (Name this something identifiable if you wish to remove it later)
    ...
    local staticObj = {
        ["name"] = namePrefix .. "FT F-14 6", -- unit name (Name this something identifiable if you wish to remove it later)
...
function DYNDECK.sc_point(shipID, templateName) -- template for deck template function
	...
	-- Copy and paste over this with the units information
											["livery_id"] = "VS-35 Blue Wolves 703 (1994)",
											["category"] = "Planes",
											["offsets"] = 
											{
												["y"] = 34.100242104084,
