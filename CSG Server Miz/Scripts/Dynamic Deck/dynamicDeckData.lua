...
--     1. dynamicDeckData.lua
--     2. dynamicDeck.lua
--
--     dynamicDeckTemplates.lua can be loaded either before or after these files
...
elseif not DYNDECK.sc_ then
    _msg = "[CSG-1 DYNDECK] TEMPLATE FILE NOT LOADED!"
    BASE:E(_msg)
end
...
DYNDECK.ship = {
    {
        name = "USS Theodore Roosevelt", -- Name will be used for ship's menu entry
        unit = "USS Theodore Roosevelt", -- name of ship unit object
